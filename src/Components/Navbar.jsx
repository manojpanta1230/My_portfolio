...
<nav className="fixed top-0 z-10 flex w-full items-center justify-between border-b border-b-gray-700 bg-black/70 px-16 py-6 text-white backdrop-blur-md md:justify-evenly">
	...
	<ul className="hidden md:flex gap-10">
		...
		<a href="#hero" className="cursor-pointer opacity-70 transition-all duration-300 hover:opacity-100">
			<li>Hero</li>
		</a>
	</ul>
	<a
		href="Manoj_Panta_CV.pdf" // Replace with your actual CV file path
		download
		className="hidden md:inline-block px-6 py-2 border border-white rounded-lg text-sm font-semibold opacity-80 transition-all duration-300 hover:bg-white hover:text-black hover:opacity-100"
	>
		Download CV
	</a>
			...
			<ul className=" hidden md:flex gap-5">
				<li className="cursor-pointer text-xl opacity-70 transition-all duration-300 hover:text-red-500 hover:opacity-100">
					<BsYoutube href='https://youtube.com'/>
				</li>
				...
				<li className="cursor-pointer text-xl opacity -70 transition-all duration-300 hover:text-black hover:opacity-100">
					<BsGithub />
				</li>
			</ul>
